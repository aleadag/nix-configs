...
let
  ...
  flavor = config.home-manager.desktop.theme.flavor;
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    programs.yazi = {
      enable = true;
      theme = builtins.fromTOML (builtins.readFile "${inputs.catppuccin-yazi}/themes/${flavor}/catppuccin-${flavor}-blue.toml");
