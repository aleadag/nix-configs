...
}:
{
  ...
  config = lib.mkIf config.home-manager.cli.fish.enable {
      ...
      interactiveShellInit =
        ...
        +
          lib.optionalString config.programs.fzf.enable
            fzfTheme."${config.home-manager.desktop.theme.flavor}";
    ...
    xdg.configFile."fish/themes/catppuccin.theme".source =
      "${flake.inputs.catppuccin-fish}/themes/Catppuccin ${libEx.capitalizeString config.home-manager.desktop.theme.flavor}.theme";
