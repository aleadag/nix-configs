    ...
    (lib.mkIf (cfg.enable && config.home-manager.window-manager.enable) {
      ...
      dconf.settings = {
        "org/gnome/desktop/interface" = with cfgFc; {
          ...
          "font-antialiasing" =
            if antialiasing != null then
              if (subpixelRendering == "none") then "grayscale" else "rgba"
            else
              "none";
          "font-hinting" = builtins.replaceStrings [ "hint" ] [ "" ] (toString hinting);
          "font-rgba-order" = toString subpixelRendering;
        };
      };
      ...
      services.xsettingsd = {
        ...
        settings = {
          ...
          "Xft/Antialias" = if cfgFc.antialiasing != null then cfgFc.antialiasing else "none";
          "Xft/Hinting" = cfgFc.hinting != null;
          "Xft/HintStyle" = toString cfgFc.hinting;
          "Xft/RGBA" = toString cfgFc.subpixelRendering;
        };
      };
